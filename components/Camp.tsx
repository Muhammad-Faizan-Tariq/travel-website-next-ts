          ...
          <div className="flexCenter gap-6">
            <span className="flex -space-x-4 overflow-hidden">
              {PEOPLE_URL.map((url)=>(
                ...
                <p className="bold-16 md:blod-20 text-white">{peopleJoined}</p>
          </div>
    ...
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        <CampSite
          ...
          title = "Murree Tour Camp"
          subtitle = "Murree, Islamabad"
          peopleJoined = "40+ Joined" 
        />
        <CampSite
          backgroundImage = "bg-bg-img-2"
          title = "K2 Mountain View Camp"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:py-20 relative w-full overflow-hidden rounded-3xl">
